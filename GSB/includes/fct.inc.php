...
/**
 * Teste si le visiteur est un comptable
 * 
 * @return vrai ou faux
 */
 ...
 * @param Boolean $comptable booléen pour déterminer le profil comptable ou non,
 *  1 si comptable 0 si visiteur
 * @return null
 */
...
/**
 * Vérifie si la date du jour est comprise entre 10 et 20 (plage de date de validation)
 *
 * @return Boolean vrai ou faux
 */
function estDateCampagneValidation()
{
    $jour = date('d');
    return (($jour <= 20) && ($jour >=10));
}
