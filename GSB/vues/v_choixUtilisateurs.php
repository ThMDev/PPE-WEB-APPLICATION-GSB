<?php
/**
 * Vue choix utilisateurs/visiteurs
 *
 * PHP Version 7
 *
 * @category  PPE
...
if ($estConnecte && estComptable()) {
    if (!isset($lesMoisDisponibles)) {
        ...
        <?php
    } else if (isset($lesMoisDisponibles)) {
        ?>
        <div class="row">                        
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <form action="index.php?uc=validerFrais&action=voirFrais" 
                    ...
                    <div class="form-group">
                        ...
                        <select id="lstMois" name="lstMois" class="form-control">
                            ...
                            foreach ($lesMoisDisponibles as $unMoisDisponible) {
                                $mois = $unMoisDisponible['mois'];
                                $numAnnee = $unMoisDisponible['numAnnee'];
                                $numMois = $unMoisDisponible['numMois'];
                    ...
                    <input id="annuler" type="reset" value="Effacer" class="btn btn-danger" 
                           role="button">
                    <a href="index.php?uc=validerFrais&action=selectionnerVisiteur" class="btn btn-danger">
